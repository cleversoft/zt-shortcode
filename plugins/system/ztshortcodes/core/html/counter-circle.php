...
<span class="chart <?php echo $options->get('extra-class'); ?>"
    ...
    data-duration="<?php echo $options->get('duration'); ?>" style="width: <?php echo $options->get('size').'px'; ?>; height: <?php echo $options->get('size').'px'; ?>; line-height: <?php echo $options->get('size').'px'; ?>">
