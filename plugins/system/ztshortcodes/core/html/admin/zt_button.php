...
<div id="<?php echo $prefix . 'container'; ?>" data-tag="" data-root="true">
    <div id="<?php echo $prefix . 'container'; ?>" data-tag="zt_button">
        <div class="form-group clearfix">
            <label for="<?php echo $prefix . 'button-text'; ?>">Text</label>
            <input type="text" data-property="" class="form-control sc-textbox" id="<?php echo $prefix . 'button-text'; ?>"
                   placeholder="Enter button caption">
        </div>
        <div class="form-group clearfix">
            <label for="<?php echo $prefix . 'button-type'; ?>">Type</label>
            <select id="<?php echo $prefix . 'button-type'; ?>" class="form-control sc-selectbox" data-property="type">
        ...
        <div class="form-group clearfix">
            ...
            <select id="<?php echo $prefix . 'button-size'; ?>" class="form-control sc-selectbox" data-property="size">
                <option value="">Standard</option>
        ...
        <div class="form-group clearfix">
            ...
            <select id="<?php echo $prefix . 'button-colour'; ?>" class="form-control sc-selectbox" data-property="colour">
        ...
        <div class="form-group clearfix">
            ...
            <div id="list-icon-button">
                <input type="hidden" id="<?php echo $prefix . 'button-icon'; ?>" class="sc-selectbox" data-property="icon">
                <?php echo getAwesome(); ?>
            </div>
        </div>
        <div class="form-group clearfix">
            <label for="<?php echo $prefix . 'button-link'; ?>">Link</label>
            <input type="text" data-property="link" class="form-control sc-textbox" id="<?php echo $prefix . 'button-link'; ?>"
                   placeholder="Enter Link Button">
        </div>
        <div class="form-group clearfix">
            <label for="<?php echo $prefix . 'button-extra-class'; ?>">Extra Class</label>
            <input type="text" data-property="extra-class" class="form-control sc-textbox" id="<?php echo $prefix . 'button-extra-class'; ?>"
                   placeholder="Enter Extra Class Button">
        </div>
    </div>
</div>